...
export const coursesCatalog: Course[] = [
  ...
  { code: "CCE 212", arabicName: "هندسة الحاسب", englishName: "Computer Engineering", credits: 3, category: "متطلبات تخصص (إجباري)", prerequisites: [], idealSemester: "Level Two - Term 2", department: "هندسة الميكاترونيات" },
  ...
  { code: "PDE 321", arabicName: "نظرية اهتزازات", englishName: "Theory of Vibrations", credits: 3, category: "متطلبات تخصص (إجباري)", prerequisites: ["EMP 012"], idealSemester: "Level Three - Term 1", department: "هندسة الميكاترونيات" },
