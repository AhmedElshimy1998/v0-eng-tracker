...
import { LayoutDashboard, BookOpen, Calendar, Sun, Moon, GraduationCap, Settings, Shield, Map, Calculator } from "lucide-react"
...
const navigation = [
  ...
  { name: "Degree Audit (الخريطة)", href: "/degree-audit", icon: Map }, // <== جديد للطلاب
  { name: "GPA Simulator (المحاكاة)", href: "/simulator", icon: Calculator }, // <== جديد للطلاب
